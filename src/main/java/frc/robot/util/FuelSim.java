...
public class FuelSim {
    ...
    public void logFuels() {
        // fuelPublisher.set(fuels.stream().map((fuel) ->
        // fuel.pos).toArray(Translation3d[]::new));
        Logger.recordOutput("FuelSim/FuelPoses",
