...
public class GameUtil {
     ...
     * 
     */
    public static Pose2d getPoseFromAuto(String autoName) {
        // Reset the pose based on alliance and selected autonmous
        PathPlannerAuto pathPlannerAuto = new PathPlannerAuto(autoName);
        Pose2d startPose = pathPlannerAuto.getStartingPose();

        if (startPose != null) {
            return AllianceFlipUtil.apply(startPose);
        }
