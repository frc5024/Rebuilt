...
public class RebuiltRobotContainer extends RobotContainer {
    ...
    //Creates the method configureAutoChooser, which sets up the autonomous command chooser with various autonomous routines and system identification routines for the robot.
    @Override
