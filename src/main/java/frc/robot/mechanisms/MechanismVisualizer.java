...
public class MechanismVisualizer {
     ...
     * 
     */
    public void update(double intakeArmAngle, double hopperPosition, double turretArmAngle, double climbShaftLength,
            double feederArmPosition, Pose3d turretPose, double shooterVelocity, Rotation2d[] wheelAngles) {
        // update the 2d mechanisims
        robotMechanism.setMechanisms(intakeArmAngle, hopperPosition, turretArmAngle, climbShaftLength,
                feederArmPosition);

        // Log component positions to AK
