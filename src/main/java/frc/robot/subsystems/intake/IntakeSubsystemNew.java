...
public class IntakeSubsystemNew extends SubsystemBase {
     ...
     * 
     */
    public IntakeSubsystemNew(ArmModuleIO armModuleIO, RollerModuleIO rollerModuleIO) {
    ...
    public void periodic() {
        ...
        Logger.recordOutput("IntakeNew/IsExetended", armModuleIO.isExtended());
        Logger.recordOutput("IntakeNew/IsRetracted", armModuleIO.isRetracted());
        Logger.recordOutput("IntakeNew/CurrentAngle", armModuleIO.getPosition());
        Logger.recordOutput("IntakeNew/SetPointAngle", armModuleIO.getGoalPosition());
        Logger.recordOutput("IntakeNew/CurrentRPM", rollerModuleIO.getVelocity());
        Logger.recordOutput("IntakeNew/SetPointRPM", rollerModuleIO.getGoalVelocity());
    }
