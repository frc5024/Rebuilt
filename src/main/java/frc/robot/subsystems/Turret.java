...
public class Turret extends SubsystemBase {
    ...
    // Enable continuous input so the controller will take the shortest path across the -180/180 wrap
    ...
    public double getCurrentVelocity() {
        ...
        // turretMotor.getEncoder().getVelocity() returns motor RPM (rotations per minute)
        double motorRPM = turretMotor.getEncoder().getVelocity();
        // Convert motor RPM -> turret rotations per second by dividing by gear ratio and 60
    ...
    public Command stickRotation(){
        return new StickRotationCommand(this, RobotContainer.driverController);
    }
