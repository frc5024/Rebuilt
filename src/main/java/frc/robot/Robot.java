...
public class Robot extends LoggedRobot {
  ...
  /** This autonomous runs the autonomous command selected by your {@link MapleSimRobotContainer} class. */
  @Override
  ...
  /**
   * Checks the driverstation alliance. We have have to check repeatedly because we don't know when
   * the driverstation/FMS will connect, and the alliance can change at any time in the shop.
   */
