...
public class TunerConstantsSim {
    // Both sets of gains need to be tuned to your individual robot.

    // The steer motor uses any SwerveModule.SteerRequestType control request with
    // the
    // output type specified by SwerveModuleConstants.SteerMotorClosedLoopOutput
    private static final Slot0Configs steerGains = new Slot0Configs().withKP(60).withKI(0).withKD(0.5).withKS(0.1)
            .withKV(2.66).withKA(0).withStaticFeedforwardSign(StaticFeedforwardSignValue.UseClosedLoopSign);
    // When using closed-loop control, the drive motor uses the control
    // output type specified by SwerveModuleConstants.DriveMotorClosedLoopOutput
    private static final Slot0Configs driveGains = new Slot0Configs().withKP(0.5).withKI(0).withKD(0).withKS(0.14786)
            .withKV(0.756878);
    ...
    public static final CANBus kCANBus = new CANBus("CANbus2", "./logs/example.hoot");
    ...
    private static final Distance kWheelRadius = Meters.of(.052988);
    ...
    private static final Distance kFrontLeftXPos = Inches.of(10.87);
    private static final Distance kFrontLeftYPos = Inches.of(10.87);
    ...
    private static final Angle kFrontRightEncoderOffset = Rotations.of(0.197265625);
    private static final boolean kFrontRightSteerMotorInverted = true;
    private static final boolean kFrontRightEncoderInverted = false;

    private static final Distance kFrontRightXPos = Inches.of(10.87);
    private static final Distance kFrontRightYPos = Inches.of(-10.87);
    ...
    private static final Distance kBackLeftXPos = Inches.of(-10.87);
    private static final Distance kBackLeftYPos = Inches.of(10.87);
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(-0.447998046875);
    private static final boolean kBackRightSteerMotorInverted = true;
    private static final boolean kBackRightEncoderInverted = false;

    private static final Distance kBackRightXPos = Inches.of(-10.87);
    private static final Distance kBackRightYPos = Inches.of(-10.87);
