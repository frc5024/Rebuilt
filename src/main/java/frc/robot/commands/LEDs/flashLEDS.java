...
public class flashLEDS extends Command {
    ...
    public flashLEDS(LEDSubsystem leds, ILEDPreset colour, int flashSeconds) {
    ...
    public flashLEDS(LEDSubsystem leds, ILEDPreset colour1, ILEDPreset colour2, int flashSeconds) {
